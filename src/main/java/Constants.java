...
public class Constants {
  ...
  static  List<String> getQueriesLagAvg(String topicName, String gname) {
    List<String> querieslag = new ArrayList<>();
    String topic1lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "sum(avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+ "%22,namespace=%22default%22%7D%5B20s%5D))" +
            "%20by%20(consumergroup,topic)";


    String topic1p0lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+
            "%22,partition=%220%22,namespace=%22default%22%7D%5B20s%5D)";
    String topic1p1lag ="http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+
            "%22,partition=%221%22,namespace=%22default%22%7D%5B20s%5D)";
    String topic1p2lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+
            "%22,partition=%222%22,namespace=%22default%22%7D%5B20s%5D)";
    String topic1p3lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+
            "%22,partition=%223%22,namespace=%22default%22%7D%5B20s%5D)";
    String topic1p4lag = "http://prometheus-operated:9090/api/v1/query?query=" +
            "avg_over_time(kafka_consumergroup_lag%7Bconsumergroup=%22"+gname+"%22,topic=%22"+ topicName+
            "%22,partition=%224%22,namespace=%22default%22%7D%5B20s%5D)";
